...
/**
 * Small synchronous SHA-256 implementation so import IDs stay deterministic
 * in browsers, workers, and Node without a runtime or package dependency.
 */
